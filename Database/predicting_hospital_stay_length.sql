...
--
-- Host: localhost
-- Generation Time: Jan 20, 2025 at 01:43 PM
...
--
-- Database: `predicting_hospital_stay_length`
--
CREATE DATABASE IF NOT EXISTS `predicting_hospital_stay_length` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `predicting_hospital_stay_length`;
...
('euf5lac47d5ebf0m3ev9s3er3qqa6zad', 'eyJ1c2VyaWQiOjJ9:1srF0s:KRAihSnx28AtUpOsPFZRnsacCLEiUrfulO0WXeNS-gY', '2024-10-03 11:07:54.417591'),
...
(2, 'Manjunath', 'tmksmanju14@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,8th Cross,Malleshwaram', 'Male');
...
(6, 'Random Forest Classifier', '50.34246575342466'),
(7, 'SVM', '52.3972602739726'),
(8, 'Logistic Regression', '52.73972602739726'),
(9, 'MLPClassifier', '51.369863013698634'),
(10, 'Gradient Boosting Classifier', '48.28767123287671');
...
(8, 'More', '20.0'),
(9, 'Dischargeable', '80.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_hospital_stay_length_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_hospital_stay_length_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(3000) NOT NULL,
  `Name` varchar(3000) NOT NULL,
  `Age` varchar(3000) NOT NULL,
  `Gender` varchar(3000) NOT NULL,
  `BloodType` varchar(3000) NOT NULL,
  `MedicalCondition` varchar(3000) NOT NULL,
  `DateofAdmission` varchar(3000) NOT NULL,
  `Doctor` varchar(3000) NOT NULL,
  `Hospital` varchar(3000) NOT NULL,
  `InsuranceProvider` varchar(3000) NOT NULL,
  `RoomNumber` varchar(3000) NOT NULL,
  `AdmissionType` varchar(3000) NOT NULL,
  `Medication` varchar(3000) NOT NULL,
  `TestResults` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;

--
-- Dumping data for table `remote_user_hospital_stay_length_prediction`
--

INSERT INTO `remote_user_hospital_stay_length_prediction` (`id`, `Fid`, `Name`, `Age`, `Gender`, `BloodType`, `MedicalCondition`, `DateofAdmission`, `Doctor`, `Hospital`, `InsuranceProvider`, `RoomNumber`, `AdmissionType`, `Medication`, `TestResults`, `Prediction`) VALUES
(1, '172.217.12.131-10.42.0.151-443-34211-6', 'Mrs. Brandy Flowers', '51', 'Male', 'O-', 'Arthritis', '09-07-21', 'Dustin Griffin', 'Jones, Brown and Murray', 'UnitedHealthcare', '477', 'Urgent', 'Paracetamol', 'Abnormal', 'More'),
(2, '131.253.61.100-10.42.0.211-443-44713-6', 'Sharon Perez', '39', 'Female', 'O-', 'Asthma', '15-12-22', 'Jessica Bailey', 'Brown-Golden', 'Blue Cross', '310', 'Urgent', 'Aspirin', 'Normal', 'Dischargeable'),
(3, '172.217.3.97-10.42.0.42-443-34555-6', 'Mrs. Caroline Farrell', '23', 'Female', 'O-', 'Hypertension', '09-06-19', 'William Miller', 'Rose Inc', 'Medicare', '126', 'Emergency', 'Paracetamol', 'Normal', 'Dischargeable'),
(4, '10.42.0.151-10.42.0.1-32216-53-17', 'William Page', '72', 'Female', 'A+', 'Diabetes', '29-07-21', 'James Carney', 'Richardson-Powell', 'Cigna', '492', 'Elective', 'Aspirin', 'Normal', 'Dischargeable'),
(5, '172.217.6.238-10.42.0.151-443-46281-6', 'Susan Mills', '59', 'Male', 'O+', 'Diabetes', '08-03-20', 'Shannon Pineda', 'Myers, Clark and Mccarty', 'Blue Cross', '247', 'Elective', 'Paracetamol', 'Normal', 'Dischargeable');
