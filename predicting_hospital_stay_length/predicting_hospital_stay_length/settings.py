...
ROOT_URLCONF = 'predicting_hospital_stay_length.urls'
...
WSGI_APPLICATION = 'predicting_hospital_stay_length.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'predicting_hospital_stay_length',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
