"""predicting_hospital_stay_length URL Configuration
...
from predicting_hospital_stay_length import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Hospital_Stay_Length_Type/$', remoteuser.Predict_Hospital_Stay_Length_Type, name="Predict_Hospital_Stay_Length_Type"),
    ...
    url(r'^View_Predicted_Hospital_Stay_Length_Type_Ratio/$', serviceprovider.View_Predicted_Hospital_Stay_Length_Type_Ratio, name="View_Predicted_Hospital_Stay_Length_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Hospital_Stay_Length_Type_Details/$', serviceprovider.View_Predicted_Hospital_Stay_Length_Type_Details, name="View_Predicted_Hospital_Stay_Length_Type_Details"),
